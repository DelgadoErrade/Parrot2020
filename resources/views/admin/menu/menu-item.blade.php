...
<li class="dd-item dd3-item" data-id="{{$item["id"]}}">
    ...
    <a href="{{route("editar_menu", ['id' => $item["id"]])}}">{{$item["nombre"] . " | Url -> " . $item["url"]}} | Icono -> <i style="font-size:20px;" class="fa fa-fw {{isset($item["icono"]) ? $item["icono"] : ""}}"></i></a>
        ...
        <a href="{{route('eliminar_menu',['id'=>$item["id"]])}}" class="eliminar-menu float-right tooltipsC" title="Eliminar este item"><i style="font-size:20px;" class="text-danger fa fa-trash"></i></a>
